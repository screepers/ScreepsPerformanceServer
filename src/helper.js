...
export default class Helper {
  ...
  static async setPassword(roomName, roomsSeen, playerRooms, cliPort) {
    ...
    await this.executeCliCommand(`storage.db.users.update({username: '${roomName}'}, {$set: {password: '', salt: '8592666ec92a801874b463ea4c0a0da519936246d54bc4c40391f9ac7c5a8000'}})`, cliPort);

    if (playerRooms[roomName]) {
      console.log(`Set steam id for ${roomName}`);
      await this.executeCliCommand(`storage.db.users.update({username: '${roomName}'}, {$set: {steam: {id: '${playerRooms[roomName]}'}}})`, cliPort);
    }
  }
